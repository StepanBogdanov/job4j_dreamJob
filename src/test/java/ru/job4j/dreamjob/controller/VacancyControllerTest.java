...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestOneVacancyThenGetPageWithVacancy() {
    ...
    @Test
    public void whenRequestVacancyWithWrongIdThenGetErrorPage() {
    ...
    @Test
    public void whenUpdateWrongVacancyThenGetErrorPage() {
    ...
    @Test
    public void whenDeleteVacancyWithWrongIdThenGetErrorPage() {
